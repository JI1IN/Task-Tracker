...
function Home() {
  return (
    <div>
      <section className="flex flex-col justify-center items-center min-h-screen bg-orange-100 text-center px-4 pt-16">
        <div className="bg-orange-200 p-8 sm:p-16 rounded-lg shadow-xl w-full sm:w-1/2">
      ...
      <section className="flex flex-col sm:flex-row justify-between items-center bg-orange-50 px-6 sm:px-32 py-10 min-h-screen">
